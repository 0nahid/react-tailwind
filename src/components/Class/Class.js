        ...
        <section class="text-gray-600 body-font">
            <div class="container flex flex-wrap px-5 py-24 mx-auto items-center">
                <div class="md:w-1/2 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Lorem, ipsum dolor.</h1>
                    <p class="leading-relaxed text-base">Lorem ipsum, dolor sit . In Lorem ipsum dolor, sit amet consectetur  elit. Nostrum, aut ad  esse,ex ab quos sed sit .Nostrum, aut ad  esse,ex ab quos sed sit?</p>
                    <a href="/" class="text-green-500 inline-flex items-center mt-4">Learn More
